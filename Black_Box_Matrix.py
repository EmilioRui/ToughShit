...
# # simulation
# var = Variation.query().get('TAR-0012-01')
# # sim = Simulation.query().get(126)
...
#         Njs.append(ej.n_array)
# #
# freq_qc = np.array(sim.data.frequencies)
# chispice = sim.data.chi

# freq = []
# for i, f in enumerate(freq_qc):
...
# print(black_box_hamiltonian(fs, ejs, fzpfs, cos_trunc=5, fock_trunc=8))
